    ...
    return (
        <>
            ...
            <div className="flex justify-center px-5  ">
                <img className="h-60 w-60 bg-white p-2 mt-4 mb-4 rounded-full   " src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80" alt="" />
