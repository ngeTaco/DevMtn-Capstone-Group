...
function ItemInCart(props) {
    ...
    const {quanitkey, total} = props.itemData
    console.log('props', props)
    return (
        <div className="flex flex-col text-lg">
            <li className="size-16 flex items-center space-x-4 mt-5">
                <div className="flex flex-col items-center">
                    <img src={imageUrl} alt={itemName} className="w-12 h-12" />
                    <input type="number" id="minimum" min="1" placeholder={quanitkey} className="mt-2 border rounded-md p-1 w-16 text-center" />
